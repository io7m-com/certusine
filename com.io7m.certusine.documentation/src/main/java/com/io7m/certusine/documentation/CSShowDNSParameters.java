...
public final class CSShowDNSParameters
{
  ...
  private static void writeProvider(
    final CSDNSConfiguratorProviderType provider)
    throws Exception
  {
    final var documents =
    ...
    final var path = Paths.get("dns-" + provider.name() + "-parameters.xml");
    try (var output =
