...
public final class CSFakeHetznerServer implements AutoCloseable
{
  private final Server server;
  private final ServletContextHandler servlets;

  public CSFakeHetznerServer(
  ...
  public static CSFakeHetznerServer create(
    final int port)
    throws Exception
  {
    final var server =
    ...
    servlets.addServlet(CSFakeHetznerDNSServlet.class, "/records/*");

    server.setHandler(servlets);
    server.start();
    return new CSFakeHetznerServer(server, servlets);
  }
  ...
  public void setResponseCode(
    final int code)
  {
    CSFakeHetznerDNSServlet.responseCode = code;
  }
}
