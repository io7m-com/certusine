...
public final class CSTestDirectories
{
  private static final Logger LOGGER =
    LoggerFactory.getLogger(CSTestDirectories.class);

  private CSTestDirectories()
  {
    ...
    throws IOException
  {
    ...
    final var path = Path.of(property).resolve("certusine");
  ...
  public static Path resourceOf(
    ...
    throws IOException
  {
    final var internal = String.format("/com/io7m/certusine/tests/%s", name);
