...
public final class CSFakeEtcdServer implements AutoCloseable
{
  private final Server server;

  public CSFakeEtcdServer(
    final Server inServer)
  {
    this.server = Objects.requireNonNull(inServer, "server");
  }

  public static CSFakeEtcdServer create(
    final int port)
    throws Exception
  {
    final var server =
    ...
    server.start();
    return new CSFakeEtcdServer(server);
  }
