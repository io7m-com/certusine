...
public final class CSFakeGandiServer implements AutoCloseable
{
  private final Server server;
  private final ServletContextHandler servlets;

  public CSFakeGandiServer(
  ...
  public static CSFakeGandiServer create(
    final int port)
    throws Exception
  {
    final var server =
    ...
    servlets.addServlet(CSFakeGandiDNSServlet.class, "/v5/livedns/*");

    server.setHandler(servlets);
    server.start();
    return new CSFakeGandiServer(server, servlets);
  }
  ...
  public void setResponseCode(
    final int code)
  {
    CSFakeGandiDNSServlet.responseCode = code;
  }
}
