 ...
 * @param target          The output to which the certificate was stored
 */

public record CSEventCertificateStored(
  CSDomain domain,
  ...
  implements CSEventType
{
  ...
  public CSEventCertificateStored
  {
  ...
  {
    return "certificate storage succeeded";
  }
  ...
  public Map<String, String> attributes()
  {
    return Map.ofEntries(
      ...
      Map.entry("certusine.target", this.target)
    );
  }
}
